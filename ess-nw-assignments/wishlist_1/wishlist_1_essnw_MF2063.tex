...
\item How do we implement a static schedule on the network as a whole?
\item How do you run a program you've written yourself on bootup, for example the computer vision application?
\end{enumerate}
