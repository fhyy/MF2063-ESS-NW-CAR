...
Take up the objectives that were achieved, not achieved, and any work remaining in the curren tor future project.
\begin{itemize}
    \item List of obtained goals
    \item Table of missed requirements and an action plan
\end{itemize}
