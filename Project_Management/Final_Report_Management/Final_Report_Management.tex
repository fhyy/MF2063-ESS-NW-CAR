...
A prototye for an autonomous car has been built. As requested, the car is able to
...
The integration issues consisted mostly of problems with the interprocess communication
...
The interprocess communication and the PCB issues were the main causes of delay in the
project.
...
However, the group had quite a few experiences with innefficient meetings and throughout most
...
alot of tasks hade to be postponed and the order of some of the tasks had to be changed as well.
This was mostly due to integration problems with the different software subsystems that had
been developed. Something that was missing in the timeplan that could have mitigated this issue
was to set aside a few days for implementing the interprocess communication between software tasks,
