...
\item The physical layer have been set in a topology that allows the SDN-system
...
\begin{itemize}
    ...
    \item The final versions of the time and resource plans are attached as an appendix
\end{itemize}
