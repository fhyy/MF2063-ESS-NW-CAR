...
An Arduino Micro handles both the generating the trig pulse and interpreting the echo signal. After the Arduino sends out the trig pulse, it waits for 2 ms, then reads the value from the pin connected to sensor's echo pin.
