...
This report presents the process and results of two projects "Embedded Service for Self-adaptive Network" (ESS-NW) and "Embedded Service for Self-adaptive Car" (ESS-CAR). 
% TODO what content each subsection describes
...
\subsection{Communication between Beaglebones}

\subsection{Communication between Beaglebone and Arduino}

\subsection{Implementing the OS}
